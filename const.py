...
# ==================== 行业配置（用于行业轮动策略）====================
# 重点关注的行业列表（使用akshare标准名称）
# 注意：东方财富行业分类使用罗马数字分级，如"白酒Ⅱ"、"证券Ⅱ"
INDUSTRY_LIST = [
    # 金融
    "银行", "证券Ⅱ", "保险Ⅱ", "多元金融",
    # 消费（白酒是核心，必须正确）
    "白酒Ⅱ", "饮料乳品", "食品加工", "白色家电", "黑色家电",
    # 医药
    "医药商业", "化学制药", "中药Ⅱ", "医疗器械", "医疗服务", "生物制品",
    # 科技
    "半导体", "消费电子", "通信设备", "计算机设备", "软件开发", "IT服务",
    # 新能源
    "光伏设备", "电池", "能源金属", "电力", "电网设备",
    # 周期
    "煤炭开采", "贵金属", "工业金属", "钢铁", "化学原料", "石油石化",
    # 制造
    "汽车零部件", "专用设备", "通用设备", "工程机械", "自动化设备",
    # 军工
    "军工电子Ⅱ", "航空装备Ⅱ", "地面兵装Ⅱ", "航海装备Ⅱ",
    # 其他
    "房地产", "建筑装饰", "传媒", "游戏Ⅱ", "零售", "旅游零售"
]
